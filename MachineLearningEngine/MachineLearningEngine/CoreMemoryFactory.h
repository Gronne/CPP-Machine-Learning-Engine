...
public:
	...
	static ICoreMemory& all(ICoreMemory& memory) { return *(new AllMemory(memory); }
	...
	static ICoreMemory& next(ICoreMemory& memory) { return *(new AllMemory(memory); }
	...
	static ICoreMemory& cluster(ICoreMemory& memory) { return *(new AllMemory(memory); }
