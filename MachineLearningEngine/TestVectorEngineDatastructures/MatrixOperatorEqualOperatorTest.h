...
TEST(MatrixOperatorEqualOperator, equalOperatorSameSize)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorSmallToLarge)
{
	Matrix *matrix1 = new Matrix(2, 3);
	*matrix1 = { 1, 2, 3,
				 4, 5, 6 };
...
TEST(MatrixOperatorEqualOperator, equalOperatorLargeToSmall)
{
	Matrix *matrix1 = new Matrix(2, 3);
	*matrix1 = { 1, 2, 3,
				 4, 5, 6 };
...
TEST(MatrixOperatorEqualOperator, equalOperatorNotSet)
{
	Matrix *matrix1 = new Matrix(2, 3);
	*matrix1 = { 1, 2, 3,
				 4, 5, 6 };
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble1x3)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble2x2)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble3x3)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble4x4)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble2x3)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDouble3x2)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorDoubleTypes)
{
	Matrix *matrix = new Matrix(1, 3);
...
TEST(MatrixOperatorEqualOperator, equalOperatorChainSquare)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorChainRows)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorChainColumns)
{
...
TEST(MatrixOperatorEqualOperator, equalOperatorVectorChainSquare)
{
	Matrix *matrix1 = new Matrix(3, 3);
	Matrix *matrix2 = new Matrix();
	Matrix *matrix3 = new Matrix();
...
TEST(MatrixOperatorEqualOperator, equalOperatorVectorChainRows)
{
	Matrix *matrix1 = new Matrix(4, 2);
	Matrix *matrix2 = new Matrix();
	Matrix *matrix3 = new Matrix();
...
TEST(MatrixOperatorEqualOperator, equalOperatorVectorChainColumns)
{
	Matrix *matrix1 = new Matrix(2, 4);
	Matrix *matrix2 = new Matrix();
	Matrix *matrix3 = new Matrix();
