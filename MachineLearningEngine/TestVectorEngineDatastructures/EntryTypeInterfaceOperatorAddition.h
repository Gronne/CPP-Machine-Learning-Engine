...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_noInitiliation_noInitialisation)
{
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_initiliation_noInitialisation)
{
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_noInitiliation_initialisation)
{
	EntryTypeNumber numberObject(5);
	EntryType number(numberObject);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_initiliation_initialisation)
{
	EntryTypeNumber numberObject(5);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_number_number)
{
	...
	EntryTypeNumber resultNumber_1(10);
	EntryTypeNumber resultNumber_2(0);
	EntryTypeNumber resultNumber_3(15);
	EntryTypeNumber resultNumber_4(-5);
	EntryTypeNumber resultNumber_5(5);
	EntryTypeNumber resultNumber_6(-15);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_number_Complex)
{
	EntryTypeNumber numberObject(5);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_number_Variable)
{
	EntryTypeNumber numberObject(5);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_Complex_Complex)
{
	...
	EntryTypeComplex resultComplex_1(10);
	EntryTypeComplex resultComplex_2(0);
	EntryTypeComplex resultComplex_3(15);
	EntryTypeComplex resultComplex_4(-5);
	EntryTypeComplex resultComplex_5(5);
	EntryTypeComplex resultComplex_6(-15);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_complex_number)
{
	EntryTypeComplex complexObject(5);
	EntryTypeNumber numberObject(5);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_complex_Variable)
{
	EntryTypeComplex complexObject(5);
	EntryTypeVariable variableObject("a");
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_variable_variable)
{
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_variable_number)
{
	EntryTypeVariable variableObject("a");
	EntryTypeNumber numberObject(5);
...
TEST(TensorCoreTensorCoreEntryTypeAddition, addition_variable_complex)
{
	EntryTypeVariable variableObject("a");
	EntryTypeComplex complexObject(5);
